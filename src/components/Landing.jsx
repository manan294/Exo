...
const Landing = () => {
    return (
        <div className='relative w-full h-[200vh]'>
            ...
            <div className='absolute top-0   max-w-screen-2xl mx-auto px-5 sm:px-10'>
                <div className='para mt-72 text-white'>
                    <p className='text-md font-regular'>Global digital design studio patnering</p>
                    <p className='text-md font-regular'>with brands and buisnesses that create</p>
                    <p className='text-md font-regular'>exceptional experience where people</p>
                    <p className='text-md font-regular'>live,  work, and unwind.</p>
                </div>
                <div className='headings text-white mt-5'>
                ...
                <div className='para-2 text-white mt-20'>
