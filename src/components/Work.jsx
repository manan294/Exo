                ...
                <div className='elems mt-10 sm:flex sm:gap-[6.5vh] flex-wrap'>
                    {elems.map((items, index) => {
                        ...
                        return <div className='elem w-full sm:w-[48%] mt-15'>
                            <div className='video border-none rounded-lg bg-zinc-500 shadow-lg shadow-zinc-500/50 w-full relative overflow-hidden h-[104vw] sm:h-[100vh] sm:w-[90vh]  '>
                                <img className=' hidden sm:block w-full h-full object-cover' src={items.image} alt="" />
                                <video className='block sm:hidden w-full h-full absolute scale-[1.3] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2' autoPlay muted loop src={items.video}></video>
                            </div>
                            <div className='mt-4'>
